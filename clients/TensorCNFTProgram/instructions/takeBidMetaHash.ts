...
export const TAKE_BID_META_HASH_DISCRIMINATOR = new Uint8Array([
  85, 227, 202, 70, 45, 215, 10, 193,
]);

export function getTakeBidMetaHashDiscriminatorBytes() {
...
export function getTakeBidMetaHashInstructionDataEncoder(): Encoder<TakeBidMetaHashInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: TAKE_BID_META_HASH_DISCRIMINATOR }),
  );
}
