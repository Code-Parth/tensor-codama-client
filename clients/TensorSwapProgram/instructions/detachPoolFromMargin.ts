...
export const DETACH_POOL_FROM_MARGIN_DISCRIMINATOR = new Uint8Array([
  182, 54, 73, 38, 188, 87, 185, 101,
]);

export function getDetachPoolFromMarginDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DETACH_POOL_FROM_MARGIN_DISCRIMINATOR,
  );
}
...
export function getDetachPoolFromMarginInstructionDataEncoder(): Encoder<DetachPoolFromMarginInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: DETACH_POOL_FROM_MARGIN_DISCRIMINATOR,
    }),
  );
}
