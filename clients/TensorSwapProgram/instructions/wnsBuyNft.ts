...
export const WNS_BUY_NFT_DISCRIMINATOR = new Uint8Array([
  216, 253, 106, 29, 182, 243, 0, 78,
]);

export function getWnsBuyNftDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(WNS_BUY_NFT_DISCRIMINATOR);
}
...
export function getWnsBuyNftInstructionDataEncoder(): Encoder<WnsBuyNftInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WNS_BUY_NFT_DISCRIMINATOR }),
  );
}

export function getWnsBuyNftInstructionDataDecoder(): Decoder<WnsBuyNftInstructionData> {
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getWnsBuyNftInstructionDataEncoder().encode(
