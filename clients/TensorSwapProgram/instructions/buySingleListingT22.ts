...
export const BUY_SINGLE_LISTING_T22_DISCRIMINATOR = new Uint8Array([
  102, 89, 66, 0, 5, 68, 84, 216,
]);

export function getBuySingleListingT22DiscriminatorBytes() {
...
export function getBuySingleListingT22InstructionDataEncoder(): Encoder<BuySingleListingT22InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: BUY_SINGLE_LISTING_T22_DISCRIMINATOR,
    }),
  );
}
