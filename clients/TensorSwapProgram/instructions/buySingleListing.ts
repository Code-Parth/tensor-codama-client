...
export const BUY_SINGLE_LISTING_DISCRIMINATOR = new Uint8Array([
  245, 220, 105, 73, 117, 98, 78, 141,
]);

export function getBuySingleListingDiscriminatorBytes() {
...
export function getBuySingleListingInstructionDataEncoder(): Encoder<BuySingleListingInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BUY_SINGLE_LISTING_DISCRIMINATOR }),
  );
}
