...
export const WNS_SELL_NFT_TRADE_POOL_DISCRIMINATOR = new Uint8Array([
  169, 175, 125, 88, 1, 16, 130, 7,
]);

export function getWnsSellNftTradePoolDiscriminatorBytes() {
...
export function getWnsSellNftTradePoolInstructionDataEncoder(): Encoder<WnsSellNftTradePoolInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: WNS_SELL_NFT_TRADE_POOL_DISCRIMINATOR,
    }),
  );
}

export function getWnsSellNftTradePoolInstructionDataDecoder(): Decoder<WnsSellNftTradePoolInstructionData> {
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getWnsSellNftTradePoolInstructionDataEncoder().encode(
