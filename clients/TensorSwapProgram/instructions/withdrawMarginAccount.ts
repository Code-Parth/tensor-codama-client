...
export const WITHDRAW_MARGIN_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  54, 73, 150, 208, 207, 5, 18, 17,
]);

export function getWithdrawMarginAccountDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_MARGIN_ACCOUNT_DISCRIMINATOR,
  );
}
...
export function getWithdrawMarginAccountInstructionDataEncoder(): Encoder<WithdrawMarginAccountInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: WITHDRAW_MARGIN_ACCOUNT_DISCRIMINATOR,
    }),
  );
}
