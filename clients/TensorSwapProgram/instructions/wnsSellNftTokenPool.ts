...
export const WNS_SELL_NFT_TOKEN_POOL_DISCRIMINATOR = new Uint8Array([
  40, 78, 241, 78, 204, 238, 46, 143,
]);

export function getWnsSellNftTokenPoolDiscriminatorBytes() {
...
export function getWnsSellNftTokenPoolInstructionDataEncoder(): Encoder<WnsSellNftTokenPoolInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: WNS_SELL_NFT_TOKEN_POOL_DISCRIMINATOR,
    }),
  );
}

export function getWnsSellNftTokenPoolInstructionDataDecoder(): Decoder<WnsSellNftTokenPoolInstructionData> {
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getWnsSellNftTokenPoolInstructionDataEncoder().encode(
