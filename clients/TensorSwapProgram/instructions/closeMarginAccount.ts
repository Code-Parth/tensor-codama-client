...
export const CLOSE_MARGIN_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  105, 215, 41, 239, 166, 207, 1, 103,
]);

export function getCloseMarginAccountDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_MARGIN_ACCOUNT_DISCRIMINATOR,
  );
}
...
export type CloseMarginAccountInstructionDataArgs = object;
...
export function getCloseMarginAccountInstructionDataEncoder(): Encoder<CloseMarginAccountInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CLOSE_MARGIN_ACCOUNT_DISCRIMINATOR,
    }),
  );
}
