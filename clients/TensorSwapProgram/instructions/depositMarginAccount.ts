...
export const DEPOSIT_MARGIN_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  190, 85, 242, 60, 119, 81, 33, 192,
]);

export function getDepositMarginAccountDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DEPOSIT_MARGIN_ACCOUNT_DISCRIMINATOR,
  );
}
...
export function getDepositMarginAccountInstructionDataEncoder(): Encoder<DepositMarginAccountInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: DEPOSIT_MARGIN_ACCOUNT_DISCRIMINATOR,
    }),
  );
}
