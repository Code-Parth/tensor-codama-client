...
export const WITHDRAW_MARGIN_ACCOUNT_CPI_TLOCK_DISCRIMINATOR = new Uint8Array([
  207, 235, 166, 255, 163, 162, 149, 44,
]);

export function getWithdrawMarginAccountCpiTlockDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_MARGIN_ACCOUNT_CPI_TLOCK_DISCRIMINATOR,
  );
}
...
export function getWithdrawMarginAccountCpiTlockInstructionDataEncoder(): Encoder<WithdrawMarginAccountCpiTlockInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: WITHDRAW_MARGIN_ACCOUNT_CPI_TLOCK_DISCRIMINATOR,
    }),
  );
}
