...
export const MARGIN_ACCOUNT_DISCRIMINATOR = new Uint8Array([
  133, 220, 173, 213, 179, 211, 43, 238,
]);

export function getMarginAccountDiscriminatorBytes() {
...
export function getMarginAccountEncoder(): Encoder<MarginAccountArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: MARGIN_ACCOUNT_DISCRIMINATOR }),
  );
}
